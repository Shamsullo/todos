...
class App extends React.Component{
  ...
  constructor(props){
    super(props);
      ...
      this.strikeUpstrike = this.strikeUpstrike.bind(this)
  }
        ...
        <div id="task-container">
          ...
          <div id="list-wrapper">
            {tasks.map(function(task, index){
              return( 
                <div id={index} className="task-wrapper flex-wrapper">
                  ...
                  <div style={{flex:1}}>
                    <button onClick={() => self.strikeUpstrike(task)} className="btn btn-sm btn-outline-info done">Done</button>
                  </div>
